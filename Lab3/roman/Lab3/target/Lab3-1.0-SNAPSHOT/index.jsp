...
<html>
<head>
    <title>JSP Lab3</title>
    <link rel="stylesheet" type="text/css" href="style.css" />
</head>
<body>
<form action="CalculateServlet" method="post">
    <INPUT TYPE="radio" name="radioButton" value="1" checked="checked"/>Formula1 <br>
    <img src="img1.jpg"><br>
    <INPUT TYPE="radio" name="radioButton" value="11"/>Formula11 <br>
    <img src="img11.jpg"><br>
    <INPUT TYPE="radio" NAME="radioButton" VALUE="21"/>Formula21 <br>
    <img src="img21.jpg"><hr>
